      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto px-[10%]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8">
          ...
          {metrics.map((metric, index) => (
            ...
            >
              {/* Number Zone - Fixed height to align row-wise */}
              <div className="flex-1 flex items-center justify-center w-full min-h-[140px]">
                <h2 className="text-[60px] lg:text-[85.91px] text-white font-medium tracking-[-0.5155px] leading-tight text-center drop-shadow-[0_2px_10px_rgba(255,255,255,0.2)] flex items-center justify-center whitespace-nowrap">
                  <AnimatedNumber value={metric.value} suffix={metric.suffix} />
                </h2>
              </div>
              
              <div className="w-full max-w-[260px] h-[1px] bg-gradient-to-r from-transparent via-[#bdaee7]/30 group-hover:via-[#bdaee7]/60 transition-colors duration-500 to-transparent my-10" />
